...
public class MBangunDatar {
    public static void main(String[] args) {
        // BangunDatar B1 = new BangunDatar(); // Error karena kelas abstrak tidak bisa diinstansiasi
        ...
        System.out.println("Informasi Lingkaran L1 setelah zoomOut:");
        L1.printInfo();
        System.out.println();
        ...
        System.out.println("Informasi Lingkaran L2 setelah zoomIn:");
        L2.printInfo();
        System.out.println();
